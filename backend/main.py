...
# -----------------------------------------------
# 전체 텍스트 검색 엔드포인트
# Python으로 치면: def search(q: str) -> list[dict]: ...
# -----------------------------------------------
...
def search_pages(q: str = ""):
    ...
    # 한 페이지에서 제목 매치 + 내용 매치가 동시에 있을 때 중복 제거:
    # 같은 pageId가 title match로 이미 있으면 내용 매치에서 pageId 중복 제거 안 함
    # (여러 블록 매치를 보여주는 게 더 유용하므로 중복 허용)
    # 단, 결과는 최대 20개로 제한
